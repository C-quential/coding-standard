...
namespace CquentialCodingStandard\Sniffs\Strings;

use PHP_CodeSniffer\Files\File;
use PHP_CodeSniffer\Standards\Squiz\Sniffs\Strings\DoubleQuoteUsageSniff;

/**
 * This method is mostly copied from the base class, with some differences:
 *  - If there is a variable in a string, allow it to use "" (e.g. "$date is not a valid date" is allowed in this variant)
 *  - A single quote alone in a string, is not reason enough to allow the use of "" (e.g. "Hans' pencil" is not allowed in this variant, and must be replaced with 'Hans\' pencil' - and "''" becomes '\'\'')
 */
class UnneededDoubleQuoteUsageSniff extends DoubleQuoteUsageSniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        // The use of variables in double quoted strings is a reason to allow double quotes
